...
export KUBE_NAMESPACE="console"
export KUBE_CLUSTER="gitea-demo-deploy"
export GCP_REGION="us-central1"
export GCP_PROJECT="ackube"
export DATA_DIR="us-central1"
export DATA_VOLUME="us-central1"
export SIDECAR_IMAGE_TAG="us-central1"
